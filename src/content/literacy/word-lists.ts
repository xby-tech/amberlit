...
// Pre-built word lists per phonics unit group. 15-30+ words per range for variety.
// These supplement the decodableWords on each PhonicsUnit for word-building activities.
...
export const WORD_LISTS: Record<string, string[]> = {
  ...
  'F.phonics.07-08': [
    ...
    'mild', 'maid', 'mend', 'mast', 'dint', 'dips', 'digs', 'dims',
    'mats', 'maps', 'mops', 'muds', 'mint', 'dump', 'dust',
    'madly', 'midst', 'admit', 'madam', 'misty', 'muddy', 'timid', 'stamp',
    'stand', 'spend', 'grand', 'stump', 'stomp', 'mango', 'sandy', 'dandy',
    'handy', 'dimly', 'dusty',
  ],
  'F.phonics.09-10': [
    'got', 'gap', 'gum', 'god', 'nod', 'not', 'on', 'top', 'mop', 'pod',
    'fog', 'log', 'dog', 'dot', 'pot', 'cog', 'jog', 'ton', 'pop', 'odd',
    'opt', 'gob', 'gig', 'gag', 'tog', 'mod', 'bob', 'cop', 'cod', 'con',
    'cot', 'don', 'dock', 'drop', 'dogs', 'dots', 'pots', 'tops', 'mops',
    'pods', 'logs', 'gods', 'gobs', 'nods', 'rods', 'toss', 'moss', 'boss',
    'loss', 'fond', 'pond', 'bond', 'song', 'long', 'gong', 'stop', 'spot',
    'snot', 'slot', 'plot', 'plod', 'plop', 'glob', 'stomp', 'strong', 'prong',
  ],
  'F.phonics.11-12': [
    'cat', 'cup', 'can', 'kit', 'kid', 'cap', 'cop', 'cot', 'cut', 'cod',
    'kick', 'dock', 'king', 'keg', 'cab', 'cam', 'cob', 'cog',
    'cud', 'cuff', 'clan', 'clam', 'clap', 'clip', 'clock', 'click',
    'crack', 'crisp', 'cross', 'crank', 'skull', 'skill', 'skid', 'skim',
    'skip', 'skin', 'kept', 'kelp', 'kind', 'kink',
  ...
  'F.phonics.13-14': [
    ...
    'mug', 'dug', 'pug', 'rut', 'gut', 'but', 'bus', 'pus', 'sun',
    'run', 'fun', 'gun', 'bun', 'nun', 'hub', 'pub', 'rub', 'sub', 'tub',
    'cub', 'dub', 'elm', 'elf', 'elk', 'emu', 'err', 'edge', 'else',
    'ever', 'even', 'evil', 'emit', 'edit', 'bend', 'best', 'belt', 'bell',
    'bent', 'desk', 'dent', 'felt', 'fell', 'fern', 'fend', 'fest', 'gems',
    'gels', 'gent', 'help', 'held', 'helm', 'hemp', 'hens', 'jest', 'jets',
    'kelp', 'kept', 'lend', 'lens', 'lent', 'less', 'melt', 'mend', 'menu',
    'mess', 'nest', 'nets', 'next', 'pens', 'pest', 'pets', 'rent', 'rest',
    'send', 'sent', 'self', 'sell', 'sets', 'stem', 'step', 'tent', 'tens',
    'tend', 'test', 'text', 'vent', 'vest', 'vend', 'weld', 'well', 'welt',
    'went', 'west', 'yell', 'zest',
  ],
  'F.phonics.15-16': [
    ...
    'hand', 'hard', 'harm', 'harp', 'hash', 'held', 'help', 'hemp', 'herd',
    'herb', 'hill', 'hint', 'hiss', 'horn', 'hump', 'hunt', 'husk',
    'ramp', 'ranch', 'rank', 'rant', 'rash', 'rasp', 'rent', 'rest',
    'rift', 'rind', 'risk', 'rock', 'romp', 'ruin', 'rump', 'rung', 'runt',
  ],
  'F.phonics.17-18': [
    ...
    'flag', 'flap', 'flat', 'flaw', 'fled', 'flog', 'flop', 'fold', 'folk',
    'fond', 'font', 'ford', 'fork', 'form', 'fort', 'foul', 'from', 'frog',
    'frost', 'fund', 'fuss', 'fuzz', 'bang', 'bank', 'barn', 'bark',
    'bash', 'bask', 'bench', 'blend', 'bless', 'blind', 'bliss', 'block',
    'blond', 'blown', 'bluff', 'blunt', 'brand', 'brass', 'brisk', 'broad',
    'broth', 'brown', 'brush', 'build', 'bunch', 'burst',
  ],
  'F.phonics.19-20': [
    'lap', 'log', 'lip', 'jam', 'jug', 'job', 'lid', 'lit', 'let', 'lot',
    'lad', 'leg', 'jet', 'jig', 'jab', 'lab', 'lag', 'lam', 'lay', 'led',
    'lob', 'lug', 'lump', 'lush', 'lust', 'lamp', 'land', 'lank', 'lard',
    'lark', 'lash', 'last', 'lawn', 'leaf', 'lean', 'left', 'lend', 'lens',
    'lent', 'less', 'lift', 'limb', 'limp', 'link', 'lint', 'list', 'lock',
    'loft', 'long', 'lord', 'loss', 'lost', 'luck', 'lung', 'lurk',
    'jack', 'jail', 'jazz', 'jelly', 'jerk', 'jest', 'jilt', 'jinx',
    'join', 'joke', 'jolt', 'judge', 'juice', 'jump', 'junk', 'just',
    'jolly', 'jumpy', 'jumbo', 'jungle', 'lanky', 'lucky', 'lumpy',
  ],
  'F.phonics.21-22': [
    'wet', 'win', 'van', 'vet', 'wag', 'wig', 'web', 'vim', 'wad', 'wax',
    'weld', 'well', 'welt', 'went', 'west', 'wick', 'wild', 'will',
    'wilt', 'wind', 'wing', 'wink', 'wisp', 'wish', 'with', 'wolf',
    ...
    'wash', 'waist', 'watch', 'water', 'wagon', 'valid', 'value', 'visit',
  ],
  'F.phonics.23-24': [
  ...
  'F.phonics.25-26': [
    ...
    'quack', 'quaff', 'quail', 'quake', 'quest', 'quill', 'quilt', 'quirk',
    'quota', 'quote', 'squid', 'squad', 'squash', 'squat', 'squint', 'squirm',
  ],
  ...
  'F.phonics.27': [
    ...
    'shift', 'shine', 'shirt', 'shock', 'shore', 'short', 'shrub', 'shrug', 'shunt',
    ...
    'polish', 'punish', 'relish', 'vanish', 'banish',
  ],
  'F.phonics.28': [
    ...
    'church', 'clutch', 'couch', 'crunch', 'ditch', 'fetch', 'hatch', 'hitch', 'hutch',
    'itch', 'kitchen', 'latch', 'launch', 'lunch', 'march', 'match', 'notch', 'patch',
    'peach', 'perch', 'pinch', 'pitch', 'pouch', 'punch', 'ranch', 'reach', 'scratch',
    'sketch', 'snatch', 'stitch', 'stretch', 'switch', 'teach', 'torch', 'touch',
    'trench', 'watch', 'witch', 'wrench', 'bench', 'branch', 'bunch', 'catch',
  ],
  'F.phonics.29': [
    'the', 'this', 'thin', 'that', 'them', 'then', 'with', 'bath', 'path', 'moth',
    'cloth', 'thick', 'thief', 'thigh', 'thing', 'think', 'third', 'thorn', 'those',
    'thought', 'thread', 'three', 'threw', 'thrill', 'throat', 'throne', 'throw',
    'thrust', 'thud', 'thumb', 'thump', 'thunder', 'beneath', 'birth', 'booth', 'both',
    'breath', 'broth', 'death', 'depth', 'earth', 'faith', 'filth', 'fifth', 'forth',
    'growth', 'health', 'length', 'math', 'month', 'mouth', 'north', 'oath', 'sloth',
    'smith', 'smooth', 'south', 'strength', 'teeth', 'theft', 'tooth', 'truth', 'warmth',
    'wealth', 'width', 'worth', 'youth', 'bathe', 'breathe', 'clothe', 'bother',
    'brother', 'father', 'feather', 'gather', 'mother', 'other', 'rather', 'weather',
  ],
  'F.phonics.30': [
    'duck', 'sock', 'kick', 'back', 'deck', 'dock', 'lock', 'luck', 'neck', 'pack',
    'pick', 'rock', 'sick', 'tack', 'tick', 'tuck', 'wick', 'block', 'brick', 'check',
    'chick', 'click', 'clock', 'crack', 'flock', 'flick', 'knock', 'mock', 'muck',
    'nick', 'peck', 'pluck', 'prick', 'quick', 'rack', 'rick', 'ruck', 'sack', 'shack',
    'shock', 'slack', 'slick', 'smack', 'snack', 'snuck', 'speck', 'stack', 'stick',
    'stock', 'struck', 'stuck', 'suck', 'thick', 'track', 'trick', 'truck', 'whack',
    'wrack', 'wreck', 'attack', 'bucket', 'chicken', 'cricket', 'jacket', 'jockey',
    'locket', 'market', 'packet', 'picket', 'pocket', 'racket', 'rocket', 'socket',
    'thicket', 'ticket', 'wicked', 'blanket', 'freckle', 'knuckle', 'lipstick',
  ],
  'F.phonics.31': [
    ...
    'slang', 'slung', 'sprang', 'sprung', 'stung', 'swung', 'tang', 'tango',
    'tongue', 'twang', 'wrung', 'young', 'anger', 'angle', 'ankle', 'bangle',
    'bungle', 'dangle', 'finger', 'ginger', 'jingle', 'linger', 'mingle', 'single',
    'singer', 'stinger', 'stronger', 'tangle', 'tingle', 'winger', 'younger',
    'kingdom', 'nothing', 'something', 'anything', 'everything',
  ...
  'F.phonics.32': [
    ...
    'whimsy', 'whereby', 'wherever', 'wholesome', 'widespread',
  ],
  ...
  'F.phonics.33': [
    ...
    'blank', 'clank', 'flock', 'glory', 'plunge', 'slump', 'blanket', 'float', 'plural',
  ],
  'F.phonics.34': [
    ...
    'tribe', 'brief', 'crude', 'drive', 'fruit', 'green', 'prove', 'trim',
  ],
  'F.phonics.35': [
    ...
    'sky', 'smile', 'snore', 'sport', 'stiff', 'swing', 'scold', 'slant', 'smooth',
    'snow', 'spray', 'sting', 'swirl', 'scope', 'slab', 'snack', 'speck', 'stack',
    'stung', 'stamp', 'stain', 'stare', 'start', 'state', 'stay', 'steal', 'steam',
    'steel', 'steep', 'steer', 'stern', 'stew', 'store', 'stork', 'storm', 'stove',
    'strap', 'straw', 'streak', 'stream', 'street', 'stress', 'stretch',
  ...
  'F.phonics.36': [
    ...
    'stunk', 'sunk', 'swank', 'tank', 'thank', 'think', 'trunk', 'wink', 'yank',
    'craft', 'draft', 'drift', 'graft', 'shaft', 'shift', 'swift', 'theft',
    'built', 'fault', 'guilt', 'halt', 'jolt', 'malt', 'salt', 'vault',
    'bolt', 'colt', 'felt', 'gilt', 'hilt', 'jilt', 'kilt', 'knelt', 'lilt',
    'pelt', 'quilt', 'silt', 'tilt', 'welt', 'gulp', 'kelp', 'pulp', 'scalp', 'yelp',
  ],
};
